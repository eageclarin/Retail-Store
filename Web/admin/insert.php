...
include '../env/adminAuth.php';
    ...
    $inventoryID = $_SESSION['inventoryID'] ;
            ...
            $AddItem_query= "INSERT INTO item( item_ID,item_Name,item_RetailPrice,item_WholesalePrice ,item_Category ,item_Brand ,item_Image) VALUES (NULL,$itemName, $RetailPrice , $WholesalePrice, $Category, $Brand, $Image )";
